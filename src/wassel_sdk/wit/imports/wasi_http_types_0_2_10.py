...
class Fields:
    ...
    def from_list(cls, entries: List[Tuple[str, bytes]]) -> Self:
        ...
        Raises: `componentize_py_types.Err(wassel_sdk.wit.imports.wasi_http_types_0_2_10.HeaderError)`
        """
        raise NotImplementedError
...
class IncomingBody:
    ...
    def stream(self) -> wasi_io_streams_0_2_10.InputStream:
        """
...
class OutgoingBody:
    ...
    def write(self) -> wasi_io_streams_0_2_10.OutputStream:
        """
...
def http_error_code(err: wasi_io_error_0_2_10.Error) -> Optional[ErrorCode]:
    """
