...
from ..imports import wasi_io_error_0_2_10
from ..imports import wasi_io_streams_0_2_10
from ..imports import wasi_clocks_wall_clock_0_2_10
...
class DescriptorStat:
    ...
    link_count: int
    size: int
    data_access_timestamp: Optional[wasi_clocks_wall_clock_0_2_10.Datetime]
    data_modification_timestamp: Optional[wasi_clocks_wall_clock_0_2_10.Datetime]
    status_change_timestamp: Optional[wasi_clocks_wall_clock_0_2_10.Datetime]
...
class NewTimestamp_Timestamp:
    value: wasi_clocks_wall_clock_0_2_10.Datetime
...
class DirectoryEntryStream:
    ...
    def read_directory_entry(self) -> Optional[DirectoryEntry]:
        ...
        Raises: `componentize_py_types.Err(wassel_sdk.wit.imports.wasi_filesystem_types_0_2_10.ErrorCode)`
        """
...
class Descriptor:
    ...
    def read_via_stream(self, offset: int) -> wasi_io_streams_0_2_10.InputStream:
        """
    ...
    def write_via_stream(self, offset: int) -> wasi_io_streams_0_2_10.OutputStream:
        """
    ...
    def append_via_stream(self) -> wasi_io_streams_0_2_10.OutputStream:
        """
...
def filesystem_error_code(err: wasi_io_error_0_2_10.Error) -> Optional[ErrorCode]:
    """
